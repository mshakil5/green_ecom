                    ...
                    <div class="card-body">
                        ...
                        <form id="createThisForm">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-6">
                                                    <input type="number" class="form-control" id="vat_percent" name="vat_percent" value="{{ \App\Models\CompanyDetails::value('vat_percent') }}" readonly>
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                <div class="col-sm-6 d-flex align-items-center justify-content-end">
                            ...
                            <div class="card-footer">
                                <button type="button" id="makeSalesBtn" class="btn btn-secondary"><i class="fas fa-plus"></i> Make Sales</button>  
                                <button type="button" id="makeQuotationBtn" class="btn btn-secondary"><i class="fas fa-file"></i> Make Quotation</button>  
                            </div>
                        </form>
                    </div>
                </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#makeQuotationBtn').click(function(e) {
            e.preventDefault();
