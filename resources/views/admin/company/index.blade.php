          ...
          <div class="card-body">
            ...
            <form id="createThisForm" action="{{ route('admin.companyDetails') }}" method="POST" enctype="multipart/form-data">
              ...
              <div class="row">
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                    <label>Homepage footer content</label>
                        <textarea name="home_footer" id="home_footer" class="form-control @error('about_us') is-invalid @enderror summernote" cols="30" rows="3">{{$data->home_footer}}</textarea>
                    </div>
                </div>
