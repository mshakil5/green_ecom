<nav class="mt-2">
    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <!-- Orders -->
        <li class="nav-item dropdown {{ request()->is('admin/*-order*') ? 'menu-open' : '' }}">
            ...
            <ul class="nav nav-treeview">
                <li class="nav-item">
                    <a href="{{ route('allorders') }}" class="nav-link {{ request()->is('admin/all-order*') ? 'active' : '' }}">
        ...
        <!-- In House Orders -->
        <li class="nav-item {{ (request()->is('admin/in-house-sell*') || request()->is('admin/in-house-order*') || request()->is('admin/quotations*')) ? 'menu-open' : '' }}">
            <a href="#" class="nav-link dropdown-toggle {{ (request()->is('admin/in-house-sell*') || request()->is('admin/in-house-order*') || request()->is('admin/quotations*')) ? 'active' : '' }}">
            ...
            <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                    <a href="{{ route('quotations') }}" class="nav-link {{ (request()->is('admin/quotations*')) ? 'active' : '' }}">
                        <i class="fas fa-box nav-icon"></i>
                        <p>Quotations</p>
                    </a>
                </li>
