...
@php
    ...
    $company = \App\Models\CompanyDetails::select('fav_icon', 'company_name', 'footer_content', 'address1', 'email1', 'phone1', 'company_logo', 'facebook', 'twitter', 'instagram', 'youtube', 'currency','google_map')->first();
...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('frontend_old/css/toastr.min.css') }}">
