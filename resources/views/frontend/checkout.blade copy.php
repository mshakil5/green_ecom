        ...
        <div class="p-5">
            <div class="row">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="coupon_code left aos-init aos-animate mt-5" data-aos="fade-up" data-aos-delay="200">
                        <h3>Coupon</h3>
                        ...
                        <h3 class="summary-title">Your Order</h3>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($cart as $item)
                                        ...
                                        <tr data-entity-id="{{ $entity->id }}" data-entity-type="{{ $isBundle ? 'bundle' : 'product' }}">
                                            ...
                                            <td  style="text-align: right">{{ $currency }}{{ number_format($itemTotal, 2) }}</td>
                                        </tr>
                                    @endforeach
                            ...
                            <div class="payment_method">
                                ...
                                {{-- <div class="panel-default">
                                    ...
                                    <div id="methodPaypal" class="collapse show" data-parent="#methodPaypal" style="">
                                        <div class="card-body1">
