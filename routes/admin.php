...
Route::group(['prefix' =>'admin/', 'middleware' => ['auth', 'is_admin']], function(){
    ...
    Route::post('/quotation', [InHouseSellController::class, 'quotationStore'])->name('quotation.store');

    Route::get('/in-house-order', [InHouseSellController::class, 'index'])->name('inhouseorders');

    Route::get('/quotations', [InHouseSellController::class, 'quotations'])->name('quotations');

    Route::get('/order/edit/{orderId}', [InHouseSellController::class, 'editOrder'])->name('admin.orders.edit');

    Route::post('/order-update', [InHouseSellController::class, 'updateOrder'])->name('order.update');
